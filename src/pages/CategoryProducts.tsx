  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="w-full h-[300px] relative mt-16">
        ...
        <img 
          src={category?.slug?.includes('blazer') || category?.slug?.includes('jeans') ?
            "https://cdn.qwenlm.ai/output/8167762c-8ddb-4af8-8ab4-624b7ac6e158/t2i/51cd69c4-f972-4b8c-9315-c242042e5817/63ceb965-e34a-4897-a7fb-4ac3711ac05e.png?key=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZXNvdXJjZV91c2VyX2lkIjoiODE2Nzc2MmMtOGRkYi00YWY4LThhYjQtNjI0YjdhYzZlMTU4IiwicmVzb3VyY2VfaWQiOiI2M2NlYjk2NS1lMzRhLTQ4OTctYTdmYi00YWMzNzExYWMwNWUiLCJyZXNvdXJjZV9jaGF0X2lkIjpudWxsfQ.Ne2NpuDsspt9Fk5PkzGHeAayrQMQUXgau0eSWTPo8ek" :
            "https://cdn.qwenlm.ai/output/8167762c-8ddb-4af8-8ab4-624b7ac6e158/t2i/51cd69c4-f972-4b8c-9315-c242042e5817/63ceb965-e34a-4897-a7fb-4ac3711ac05e.png?key=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZXNvdXJjZV91c2VyX2lkIjoiODE2Nzc2MmMtOGRkYi00YWY4LThhYjQtNjI0YjdhYzZlMTU4IiwicmVzb3VyY2VfaWQiOiI2M2NlYjk2NS1lMzRhLTQ4OTctYTdmYi00YWMzNzExYWMwNWUiLCJyZXNvdXJjZV9jaGF0X2lkIjpudWxsfQ.Ne2NpuDsspt9Fk5PkzGHeAayrQMQUXgau0eSWTPo8ek"
          }
